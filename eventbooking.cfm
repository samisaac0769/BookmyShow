...
<body>
    <cfoutput>
        ...
        <div>
            <div class="bookingnav p-3 d-flex align-items-center">
                <div class="icon">
                    <a href="firstpage.cfm">
                ...
                <div class="d-flex justify-content-between">
                    <button class="back-btn px-3"><span class="material-symbols-outlined spncol">arrow_back_ios</span></button>
                    <div class="selectedeventname d-flex flex-column px-3">
                        <span>#local.event.eventname# </span>
                        <div class=" dateandplace d-flex gap-2">
                            <span>Sun 31 Dec</span>
                            ...
                            <span> | </span>
                            <span>Catch Up: #local.event.venue#</span>
                        </div>
                    </div>
                    <button class="back-btn px-3"><span class="material-symbols-outlined spncol">close</span></button>
                </div>
            </div>
            <div class="d-flex justify-content-center">
                <div class="bookeventseat d-flex flex-column">
                    <div class="heading">Select your category</div>
                    <div class="mt-3 d-flex justify-content-between">
                        <div class="d-flex flex-column">
                            <span class="PKG">Royal UNLIMITED PKG</span>
                            <Span class="PKGprice">$ #local.event.price#</span>
                            <input type="hidden" value=#local.event.price# id="seatprice">
                        </div>
                        <div class="custom-select me-3">
                            <select id="mySelect">
                                <option value="0" hidden>Select seats</option>
            ...
            <div class="d-flex justify-content-center pay-btn">
                <button class="eventpayment" type="button" id="eventpayment">pay</button>
            </div>
        </div>
    </cfoutput>
</body>
