...
<body>
    <header class="">
        <div class="navfirst">
            <div class="d-flex align-items-center justify-content-between navfirstbox">
                <div class="d-flex">
                ...
                <div class="d-flex"> 
                    <div class="d-flex p-1 pe-3 mt-1" type="button">
                        <span class="location">Trivandrum</span>
                        <span class="material-symbols-outlined down">arrow_drop_down</span>
                    </div>
                    <div>
                        <cfif !structKeyExists(session, "login") || session.login eq "">
                            ...
                            <cfif session.login eq "1">
                                <cfoutput>
                                    ...
                                    <div class="d-flex mt-1">
                                        ...
                                        <span class="user-name">Hi, #session.userDetail#</span>
                                    </div>
                                </div>
                                </cfoutput>
